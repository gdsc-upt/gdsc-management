...
public class Theme
{
    ...
    private static readonly Palette LightPalette2 = new()
    {
        AppbarText = "#424242",
    ...
    private static readonly PaletteDark DarkPalette2 = new()
    {
        AppbarText = "#92929f",
        AppbarBackground = "rgba(0,0,0,0)",
    ...
    private static readonly Shadow Shadows = new()
    {
        Elevation = new[]
        {
            "none",
    ...
    public static MudTheme Get2()
    {
        return new MudTheme
        {
            Palette = LightPalette2,
            PaletteDark = DarkPalette2,
            Shadows = Shadows,
